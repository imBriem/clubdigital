...
setSueldoEdit(rowData[i].sueldo)
  ...
  const options = {
    ...
    return(
      ...
      {/* <button type="button" class="btn btn-secondary btn-lg"  onClick={logOut} >Anticipos</button> */}
      <button type="button" class="btn btn-secondary btn-lg" /* onClick={logOut} */>Proveedores</button>
      <button type="button" class="btn btn-secondary btn-lg" /* onClick={logOut} */>Categoria</button>
      <button type="button" class="btn btn-secondary btn-lg" /* onClick={logOut} */>CompraProductos</button>
            </div>
<hr/><hr/>
<div style={{ marginLeft: '18em' }}>
        <MUIDataTable
